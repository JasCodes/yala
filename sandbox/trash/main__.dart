...
const List<Destination> allScreens = <Destination>[
...
class _HomePageState extends State<HomePage>
  ...
  void initState() {
    ...
    _faders = allScreens.map<AnimationController>((Destination destination) {
      return AnimationController(
          vsync: this, duration: Duration(milliseconds: 200));
    }).toList();
    _faders[_currentIndex].value = 1.0;
    _destinationKeys =
        List<Key>.generate(allScreens.length, (int index) => GlobalKey())
            .toList();
    ...
    return NotificationListener<ScrollNotification>(
      ...
      child: Scaffold(
        body: SafeArea(
          ...
          child: Stack(
            fit: StackFit.expand,
            children: allScreens.map((Destination destination) {
        ...
        bottomNavigationBar: ClipRect(
          child: SizeTransition(
            ...
            child: BottomNavigationBar(
              ...
              items: allScreens.map((Destination destination) {
