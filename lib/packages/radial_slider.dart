...
class _RadialSliderState extends State<RadialSlider> {
  ...
  _onPointerMove(PointerMoveEvent evt, BuildContext context) {
    var dx = evt.delta.dx, dy = evt.delta.dy;
    ...
    double r = sqrt(pow(pos.dx - context.size.width / 2, 2) +
        pow(pos.dy - context.size.height / 2, 2));
        ...
        Center(
          child: widget.background != null
              ...
              : Container(
                  ...
                  width:
                      widget.radius != null ? widget.radius * 2 + 50.0 : null,
                  height:
                      widget.radius != null ? widget.radius * 2 + 50.0 : null,
                ),
        ),
